...
for inp in inputs:
	...
	if t[0:2].encode('utf-8') in duplets:
		if t[2].encode('utf-8') in duplets[t[0:2].encode('utf-8')]:
...
for i in range(text_length):
	...
	if current.encode('utf-8') in duplets: # and duplets[current.encode('utf-8')] != {}:
		cumulative = []
		sum = 1
		lastone = i
